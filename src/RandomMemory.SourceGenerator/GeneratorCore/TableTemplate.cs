...
namespace RandomMemory.GeneratorCore
{
 ...
 for(var i = 0; i < GenerationContext.SecondaryKeys.Length; i++) { var key = GenerationContext.SecondaryKeys[i]; 
      if (!key.IsNonUnique) { 
            ...
            this.Write("\r\n#endif\r\n        }\r\n\r\n#if !DISABLE_RANDOMMEMORY_METADATABASE\r\n\r\n        public static RandomMemory.Meta.MetaTable CreateMetaTable()\r\n        {\r\n            return new RandomMemory.Meta.MetaTable(typeof(");
            ...
            #line default
            #line hidden
            this.Write("\",\r\n                new RandomMemory.Meta.MetaProperty[]\r\n                {\r\n");
 foreach(var prop in GenerationContext.Properties) { 
            this.Write("                    new RandomMemory.Meta.MetaProperty(typeof(");
            ...
            this.Write("                },\r\n                new RandomMemory.Meta.MetaIndex[]{\r\n");
 foreach(var key in GenerationContext.Keys) { 
            this.Write("                    new RandomMemory.Meta.MetaIndex(new System.Reflection.PropertyInfo[] {\r\n");
